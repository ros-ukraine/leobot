...
```bash
rosrun leobot_java example com.github.rosjava.leobot_java.example.SimpleAutoPilot
```

Crazy Auto Pilot 

```bash
rosrun leobot_java example com.github.rosjava.leobot_java.example.CrazyAutoPilot
```
